function [B,N,fn,BC] = build_bnd_gen(BC,Grid,I,rho_grav) % MDOT repo
% Warning this isa failed attempt!! Feb 8, 2023
...
% rho_grav = vector of gravitational acceleration on faces
%
% Output:
...
%% No gravity case
if isempty(rho_grav)
    rho_grav = spalloc(Grid.N,1,0); % set gravity vector to zero
end
